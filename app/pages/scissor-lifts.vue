...
const variants = [
  ...
  },
  {
    ...
    specs: [
      ...
      { label: 'Load Capacity', val: '992 lbs (450 kg)' },
      { label: 'Machine Weight', val: '4,982 lbs (2,260 kg)' },
      { label: 'Batteries', val: '4x Lithium Ion' },
      { label: 'Controller', val: 'Curtis USA' },
